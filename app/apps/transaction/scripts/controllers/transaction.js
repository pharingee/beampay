  ...
  .controller('TransactionDetailCtrl', function ($scope, $stateParams, Transaction, TransactionUtil) {
    ...
    $scope.getComment = function (comment) {
      if (comment === 'INIT') {
        ...
        return 'We\'re ready to recieve payment on your transaction.';
        ...
        return 'Sorry, this transaction has been cancelled. Please contact us for details on the cancelation. Thank you.';
