...
angular
  ...
  .constant('ErrorConstants', {
    ...
    weakPassword: 'Password must be at least 8 characters long, contain at least one numeric digit.',
    ...
    unactivatedEmail: 'An activation link has been sent to your email. Please check and activate your account',
    ...
    unverifiedFbAccount: 'Oops! Your facebook account is not verified. Please verify your facebook account and try again. Or sign up using your email.',
    fbPermissionRejected: 'Please accept Beam\'s facebook permission to use your email.',
